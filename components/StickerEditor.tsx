...
export default function StickerEditor({ sticker, onUpdate }: StickerEditorProps) {
  ...
  const normalizePath = (path: string) => {
    return path.replace(/-_(\d+)_/g, '-$1').replace(/_/g, '-');
  };
      ...
      <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <Input
                value={sticker.src}
                onChange={(e) => onUpdate({ src: normalizePath(e.target.value) })}
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              <div className="flex justify-between mb-1">
                ...
                <span className="text-sm text-gray-500">{width}rem</span>
              </div>
              <Slider
                  value={[width]}
                  min={1}
            ...
            <div>
              <div className="flex justify-between mb-1">
                ...
                <span className="text-sm text-gray-500">{height}rem</span>
              </div>
              <Slider
                  value={[height]}
                  min={1}
